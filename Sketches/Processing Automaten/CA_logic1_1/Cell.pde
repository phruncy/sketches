class Cell
{
  ...
  public Cell (int initialState, Automaton automaton)
  {
  ...
  public void generateCellParameters()
  {
    ...
    int right = (_position == (_automaton._cell.length)-1)? rightNeighbour._formerState : rightNeighbour._state;
 ...
 ///Alter wird erhöht, sobald eine Zelle zwei Generationen  
 private void setAge ()
  {
