...
leftCanvas = createGraphics(viewmodel.getBufferWidth(), height);
rightCanvas = createGraphics(viewmodel.getBufferWidth(), height);
console.log(rightCanvas.width+"rcw");
...
automaton.initialise(viewmodel.convertDecimalRule(110), 24);
